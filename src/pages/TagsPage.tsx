        ...
        <div className="p-4 space-y-4">
          ...
          <CuteCard variant="cream" className="p-4">
            ...
            {isLoadingStats ? (
              ...
              <div className="text-center py-4 text-chiikawa-brown/60">
                <CharacterAvatar character="kuri" size="md" className="mx-auto mb-2 opacity-50" />
                暂无标签数据
              </div>
            ) : (
              <div className="space-y-2">
          ...
          <CuteCard variant="cream" className="p-4">
            ...
            {isLoadingStats ? (
              ...
              <div className="text-center py-4 text-chiikawa-brown/60">
                <CharacterAvatar character="chiikawa" size="md" className="mx-auto mb-2 opacity-50" />
                暂无标签
              </div>
            ) : (
              <div className="flex flex-wrap gap-2">
          ...
          {selectedTag && (
            <CuteCard variant="pink" className="p-4">
              ...
              {isLoadingDetail ? (
                ...
                <div className="text-center py-4 text-chiikawa-brown/60">
                  <CharacterAvatar character="rakko" size="md" className="mx-auto mb-2 opacity-50" />
                  暂无关联顾客
                </div>
              ) : (
                <div className="space-y-2">
